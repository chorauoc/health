...
class HealthCalculation {
  static double calculateQualityOfLifeValue() {
    User? user = locator<UserProvider>().getSession();
    Health health = locator<AppProvider>().getHealth(user!);
  ...
  static double calculateAtivityValue() {
    User? user = locator<UserProvider>().getSession();
    Health health = locator<AppProvider>().getHealth(user!);
    Goal? goal = locator<GoalProvider>().getGoals();
  ...
  static double calculateStepsValue() {
    User? user = locator<UserProvider>().getSession();
    Health health = locator<AppProvider>().getHealth(user!);
    Goal? goal = locator<GoalProvider>().getGoals();
  ...
  static double calculateSleepTimeValue() {
    User? user = locator<UserProvider>().getSession();
    Health health = locator<AppProvider>().getHealth(user!);
    Goal? goal = locator<GoalProvider>().getGoals();
  ...
  static double calculateScreenTimeValue() {
    User? user = locator<UserProvider>().getSession();
    Health health = locator<AppProvider>().getHealth(user!);
    Goal? goal = locator<GoalProvider>().getGoals();
